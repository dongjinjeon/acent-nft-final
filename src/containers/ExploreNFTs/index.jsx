          ...
          <div className="project-menu-area d-flex align-items-center justify-content-between">
            <div className="project-left-menu">
              <ul className="nav" id="myTab" role="tablist">
                ...
                <TagButton name="YEDLAND" val="NFT Art" tagActive={tag === 'NFT Art' ? true : false} handleSetTag={setTag} />
                <TagButton name="YEDHOMES" val="Game Cards" tagActive={tag === 'Game Cards' ? true : false} handleSetTag={setTag} />
                <TagButton name="YEDHUMANS" val="Music" tagActive={tag === 'Music' ? true : false} handleSetTag={setTag} />
                <TagButton name="Collectabiles" val="Collectabiles" tagActive={tag === 'Collectabiles' ? true : false} handleSetTag={setTag} />
                <TagButton name="YEDTOKENS" val="Domains" tagActive={tag === 'Somains' ? true : false} handleSetTag={setTag} />
