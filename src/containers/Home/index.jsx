          ...
          <div className="project-menu-area d-flex align-items-center justify-content-between">
            <div className="project-left-menu">
              <ul className="nav" id="myTab" role="tablist">
                ...
                <TagButton name="YEDHOMES" val="Game" tagActive={tag === 'Game' ? true : false} handleSetTag={setTag} />
                ...
                <TagButton name="YEDTOKENS" val="Domains" tagActive={tag === 'Domains' ? true : false} handleSetTag={setTag} />
